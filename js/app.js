...
var bellWrap = document.getElementById('notificationBell');
var bellDot = document.getElementById('bellDot');
var modal = document.getElementById('bellAllert');
  ...
  var chart = new Chart(ctx, {
      ...
      data: {
          ...
          datasets: [{
              ...
              pointRadius:6,
              pointBorderWidth:3,
              data: [500, 1000, 1500, 1800, 2000, 1200, 1000],
          }]
      },
...
var myChart = new Chart(ctx, {
  ...
  data: {
    ...
    datasets: [{
        ...
        borderColor: '#415677',
        data: [50, 120, 150, 100, 200, 180, 80],
